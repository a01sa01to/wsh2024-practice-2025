...
export const Footer: React.FC = () => {
  ...
  const handleRequestToTermDialogOpen = async () => {
    const TERM = await fetch('/assets/txt/Term.txt').then((res) => res.text());
  ...
  const handleRequestToContactDialogOpen = async () => {
    const CONTACT = await fetch('/assets/txt/Contact.txt').then((res) => res.text());
  ...
  const handleRequestToQuestionDialogOpen = async () => {
    const QUESTION = await fetch('/assets/txt/Question.txt').then((res) => res.text());
  ...
  const handleRequestToCompanyDialogOpen = async () => {
    const COMPANY = await fetch('/assets/txt/Company.txt').then((res) => res.text());
  ...
  const handleRequestToOverviewDialogOpen = async () => {
    const OVERVIEW = await fetch('/assets/txt/Overview.txt').then((res) => res.text());
